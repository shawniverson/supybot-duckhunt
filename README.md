 ...
 * The bot will randomly launch ducks. Whenever a duck is launched, the first person to use the "bang" command or "bef" command wins a shot or save. 
 * Using the "bang" or "bef" command when there is no duck launched costs a shot point or a save point.
